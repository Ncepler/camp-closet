        ...
        <div className="p-5">
          {status === "success" ? (
            <div className="text-center py-8">
              ...
              <h3 className="font-semibold text-gray-900 mb-2 text-sm">Got it</h3>
              ...
              <button
                onClick={onClose}
                className="px-6 py-2 rounded text-white text-sm font-semibold transition-opacity hover:opacity-90 bg-[#2d5016]"
              >
                Done
              </button>
            </div>
